...
var Network = Backbone.Model.extend({
    ...
    createNetwork: function (data, format) {
        ...
        } else if (format === 'single') { // change format name to csv
        ...
        } else if (format === 'multiple') { //TODO: Change format name to 'split'
...
var parse_ = function (input, header) {
    input = input.replace(/ /g, ''); //remove whitespace
    if (!header) header = false;
    return Baby.parse(input, {
        header: header,
...
exports.parse = parse_; // Just for testing
