...
var Network = Backbone.Model.extend({
    ...
    initialize: function(input) {
        ...
        if (Options.inputFiles === 'multiple') {
            ...
            if (Options.loglevel > 2) console.log('The input data was given as: ' + data); //logging level 3
            if (Options.loglevel > 2) console.log('The input data was parsed as: ' + temp.data); //logging level 3
